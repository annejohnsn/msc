...
\chapter{Product spaces of $\mathbb{Z}_p$}
...
\bibitem[Ru]{rum} Rumely.
\bibitem[B1]{mb1} Manjul Bhargava, The factorial function and generlizations
\bibitem[B2]{mb2} $P$-orderings and polynomial functions on arbitrary subsets of Dedekind rings.
\bibitem[B3]{mb3} On $ P$-orderings, rings of integer-valued polynomials, and ultrametric analysis
\bibitem[J1]{kj} Keith Johnson, P-orderings and Fekete sets
\bibitem[J2]{kj2} Keith Johnson, something else
\bibitem[S]{sim} EQUILIBRIUM MEASURES AND CAPACITIES INSPECTRAL THEORY
\bibitem[A]{na} Nate Ackerman,  Completeness in Generalized Ultrametric Spaces
