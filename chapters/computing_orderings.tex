...
\begin{notation}
	Let $S$ be a compact, discretely-valued subset of an ultrametric space and $\gamma_k$ be an element of $\Gamma_S$, the set of distances in $S$. Then we denote by $v_{\gamma_k}(\delta(n))$ the exponent of $\gamma_k$ in the $n^{th}-$term of the characteristic sequence of $S$.
\end{notation}
