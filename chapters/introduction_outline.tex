...
One important consequence of this remark is that it gives a way to define capacity in a general ultrametric space: we define an analogous structure to a $p-$sequence, which we call a $\rho-$sequence, and consider the limit. 